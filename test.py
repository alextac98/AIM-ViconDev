...
def animate(i):
    ...
    z_points = [0, Z1[i], Z2[i]]

    line.set_data(x_points, y_points, z_points)
    return line,

# call the animation
ani = animation.FuncAnimation(fig, animate, frames=len(X1), interval=40, blit=False, repeat=False)
